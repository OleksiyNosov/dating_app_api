...
puts "Create #{ place_users_numb } place_users (user reviews)"
pairs = places.product(users).shuffle # TODO: Rewrite with factories that can handle complex associations

Array.new place_users_numb do
  pair = pairs.pop
...
puts "Create #{ invites_numb } invites"
pairs = events.product(users).shuffle # TODO: Rewrite with factories that can handle complex associations

Array.new invites_numb do
  pair = pairs.pop
